    ...
    <div className="w-full p-4 bg-gray-800 border border-gray-700 rounded-lg shadow">
      <form className="space-y-4" onSubmit={handleFormSubmit}>
        ...
        <div className="flex flex-row justify-evenly">
          <button
            type="reset"
            className="flex hover:bg-gray-700 text-white font-bold py-2 px-4 rounded disabled:text-gray-400 disabled:hover:bg-transparent"
            onClick={onCancel}
            disabled={isSubmitting}
          >
            Cancel
          ...
          {project && (
            <button
              type="reset"
              className="flex text-red-400 hover:bg-red-700 hover:text-white font-bold py-2 px-4 rounded disabled:text-red-900 disabled:hover:bg-transparent"
              disabled={isSubmitting}
            >
              Delete
            </button>
          ...
          <button
            type="submit"
            className="flex bg-blue-700 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded disabled:text-gray-400 disabled:bg-blue-900 disabled:hover:bg-blue-900"
            disabled={isSubmitting}
          >
