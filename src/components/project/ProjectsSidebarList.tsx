        ...
        data?.map((project: Project) => (
          <li key={project.id}>
            <Link
              ...
              className={`flex items-center justify-between w-full p-2 transition duration-75 rounded-lg pl-11 group  text-white  hover:cursor-pointer bg-gray-800 hover:bg-gray-700`}
            >
              <h2>{project.name}</h2>
            </Link>
          </li>
